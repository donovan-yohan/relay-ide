...
test.describe('SearchableSelect React component', () => {
  ...
  test('opens dropdown on trigger click', async ({ page }) => {
    ...
    await expect(page.locator('#closed-no-selection .ss-dropdown')).toBeVisible();
  ...
  test('shows no matches message for empty filter', async ({ page }) => {
    ...
    await expect(page.locator('#closed-no-selection .ss-no-results')).toBeVisible();
  });
  ...
  test('closes on Escape key', async ({ page }) => {
    ...
    await expect(page.locator('#closed-no-selection .ss-trigger')).toBeVisible();
