...
test.describe('TuiMenuItem React component', () => {
  ...
  test('renders default, icon, danger, and disabled states', async ({ page }) => {
    ...
    await expect(page.locator('#menu-danger')).toHaveClass(/tui-menu-item--danger/);
    await expect(page.locator('#menu-disabled')).toHaveClass(/tui-menu-item--disabled/);
  });
