      ...
      {!sidebarCollapsed && (
        <>
          {viewSpineEnabled ? (
            ...
            // shell so the explicit opt-in gets the fuller
            // Workspace/Project/Instance/Bench/Tab surface.
            ...
            // Default thin-line WorkspaceTopic shell. The legacy repo/workspace
            // sidebar fallback has been retired; topic-room parity is the
