  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'test-diff-file-sidebar': resolve(import.meta.dirname, 'test-diff-file-sidebar.html'),
        'test-target-branch-switcher': resolve(import.meta.dirname, 'test-target-branch-switcher.html'),
        'test-session-tab-bar': resolve(import.meta.dirname, 'test-session-tab-bar.html'),
        'test-session-item': resolve(import.meta.dirname, 'test-session-item.html'),
        'test-workspace-group': resolve(import.meta.dirname, 'test-workspace-group.html'),
        'test-workspace-item': resolve(import.meta.dirname, 'test-workspace-item.html'),
        'test-pr-top-bar': resolve(import.meta.dirname, 'test-pr-top-bar.html'),
      },
    },
  },
});
