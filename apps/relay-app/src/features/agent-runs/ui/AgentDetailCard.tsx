...
import type { AgentDetailCardV2, ReasoningTerminalState } from '../types';
...
function CardContent({ card, itemId }: { card: AgentDetailCardV2; itemId: string }) {
  ...
  if (card.kind === 'thought') {
    return (
      <ReasoningDetail
        ...
        itemId={itemId}
        size={size}
        {...(reasoningTerminalState ? { terminalState: reasoningTerminalState } : {})}
