...
type UseChannelAgentSessionsOptions = {
  ...
  setOpenAgentRunId?: PanelValueSetter;
...
export function useChannelAgentSessions({
  ...
  }, [returnTarget, setOpenAgentSessionPubkey, setOpenAgentRunId]);

  const openAgentSession = React.useCallback(
    (pubkey: string, channelId?: string | null, runId?: string | null) => {
