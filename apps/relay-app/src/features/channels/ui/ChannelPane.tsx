...
import { AgentRunViewPanel } from "@/features/agent-runs/ui/AgentRunViewPanel";
  ...
  return (
    ...
    >
      ...
      <AnimatePresence mode="wait" onExitComplete={markExitComplete}>
        ...
        ) : activeChannel && (selectedAgent || openAgentSessionPubkey) ? (
          (() => {
            const agentPubkey = openAgentSessionPubkey || selectedAgent?.pubkey;
            const panel = (
              <AgentRunViewPanel
                agentPubkey={agentPubkey!}
                channelId={openAgentSessionChannelId || activeChannel.id}
                initialRunId={openAgentRunId}
                isSinglePanelView={
            ...
            return wrapAux(panel, "agent-run-view-panel");
          })()
        ) : profilePanelPubkey ? (
          (() => {
            const panel = (
