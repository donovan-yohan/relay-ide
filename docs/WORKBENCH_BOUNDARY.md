...
| `WorkspaceTopic`   | A workspace-scoped navigation/launch-default record grouping WorkContexts, sessions, task refs, artifacts, repo/worktree bindings, and WorkspaceSurface ids. | Topics organize work and defaults; they are not Discord channels, transcript stores, task databases, or duplicate surface catalogs. |
