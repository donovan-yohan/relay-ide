...
| Path                                  | Role                                                                                                                                                                                                                                                                          |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `frontend/src/components/`            | React 19 TSX components (Terminal, Sidebar, TopicSidebarShell, ViewSpineTree, PrTopBar, WorkspaceArea, RepoDashboard, CommandPalette, dialogs, etc.)                                                                                                                          |
