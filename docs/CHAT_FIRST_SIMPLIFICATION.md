...
> channel prompt defaults + SSE hardening (#1096, #1072, #1090, #1102), and
> the default landing swapped to the chat/topic spine (#1101). Remaining:
...
| #1061 sidebar         | **done (5/5)**                | workspace grouping #1089, topic-select→context #1068, id/select-key leak sweep #1070+#1103; issue left open pending #1058 epic close                                                                                                                                                        |
