...
relay-ide v1 work-context-messages append --work-context-id <work-context-id> --kind <handoff|question|status|evidence|decision|artifact|custom> --summary <text> [--payload-file <json>] --json
