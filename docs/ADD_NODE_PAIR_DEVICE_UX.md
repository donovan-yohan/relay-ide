...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------ | ----------------------- | ----------------------------------------------------------------------- | --------------------------------------- |
| `dev workstation`        | Personal laptop/workstation. Can launch terminal sessions and read/write approved repo roots as the local OS user. | `dev`                   | terminal session + read/write within approved roots + git               | standard operator approval              |
...
- **can:** what this node will be allowed to do (e.g. "launch terminal sessions, read/write approved repo roots, run git"). Agent profiles participate in channels; pairing does not grant a public agent-session launch capability.
...
| requested capabilities     | "launch terminal sessions · attach/detach sessions · read/write approved repo roots · run git" | Product language, not raw capability bits.                                                                                          |
...
> requested access: launch terminal sessions, attach/detach sessions, read/write approved repo roots, run git operations.
